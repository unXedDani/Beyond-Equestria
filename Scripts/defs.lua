function createCharacter(scene)
	scene:createCharacter(4, 2, 0.35)
	scene:modifyCharacter("jumpheight", 200)
	scene:modifyCharacter("jumpforce", 40)
end
...
function createWindow(title, x1, y1, x2, y2, parent, script)
	local window = MainScene:addWindow(title, x1, y1, x2, y2, parent, script)
	MainScene:getGUIObject(window):drawBackground(0)
	MainScene:getGUIObject(window):drawTitlebar(0)
	MainScene:addImage(0, 0, x2-x1, y2-y1, "Assets/Levels/menu/textures/window.png", window)
